...
export const DCC: Closing = {
  mode: "quick", quickPct: 3, origPct: 0.5, pointsPct: 0, appraisal: 800, creditReport: 30,
  underwriting: 750, transferTaxPct: 0, attyFee: 1200, titleSearch: 275, lenderTitle: 900,
  ownerTitle: 1200, recordingFees: 75, firstYearInsurance: 1500, prepaidDays: 15,
  taxEscrowMonths: 3, insEscrowMonths: 2, inspection: 550, termite: 100, survey: 600,
  enviro: 0, customItems: [],
};

// Itemized expenses are all stored as ANNUAL dollars (v:2).
export const DEX: Expenses = {
  mode: "quick", ratio: 45, vacancyPct: 5.5, taxes: 7800, taxMode: "fixed", taxPct: 1.2,
  insurance: 4600, mgmtPct: 8, maintenance: 6000, maintMode: "fixed", capex: 6000,
  capexMode: "fixed", utilities: 1800, landscaping: 1200, accounting: 800, misc: 500,
  customExpenses: [], propertyClass: "B", v: 2,
};

export interface ClassPreset { ratio: number; maintenance: number; capex: number; insurance: number; label: string; hint: string }
...
export const INIT: Deal = {
  ...
  expenses: { ...DEX },
  projection: {
    appreciationPct: 4.5, holdYears: 5, rentGrowthPct: 3, sellingCostPct: 6,
    exitCapEnabled: false, exitCapRate: 6, vaEnabled: false, vaMarketRentPerUnit: 1750,
    vaYear: 2, refiEnabled: false, refiYear: 3, refiRate: 6.5,
  },
...
export const BLANK: Deal = {
  ...INIT, price: 0, address: "", notes: "", listingUrl: "", insights: null, comparables: [],
