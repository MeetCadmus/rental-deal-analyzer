...
export function Units() {
  ...
  return (
    <Card title={"Units & Rents · " + numU + " unit" + (numU !== 1 ? "s" : "")} icon="home" collapsible defaultOpen storeKey="units" summary={fmtD(totalRent) + "/mo"}>
      ...
      <div style={{ marginTop: 10 }}><MoneyInput label="Other income / mo" value={S.otherIncome || 0} onChange={(x) => set("otherIncome", x)} sub="laundry · parking · pet · storage (added to EGI)" /></div>
